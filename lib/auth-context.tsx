...
import { getAccessToken, clearTokens, refreshAccessToken, getTokenType } from "@/lib/token-service"
...
type AuthContextType = {
  ...
  login: (email: string, role?: string) => Promise<{ success: boolean; needsPasswordSetup?: boolean }>
  setupPassword: (password: string, confirmPassword: string) => Promise<{ success: boolean }>

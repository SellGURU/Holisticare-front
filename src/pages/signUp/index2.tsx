...
const SignUp = () => {
    ...
    const submit = () => {
        setIsLoading(true)
        Auth.signup(formik.values.userName,formik.values.email,formik.values.password).then(() => {
    ...
    return (
        ...
        <AuthLayout>
                ...
                <div className="text-xl font-medium text-Text-Primary text-center">Create Your Account</div>
                <div className="mt-6 grid gap-4">
                    <TextField inValid={formik.errors?.userName != undefined && (formik.touched?.userName as boolean)}  errorMessage={formik.errors?.userName} {...formik.getFieldProps("userName")} placeholder="Enter your full name..." label="Full name" type="text" ></TextField> 

...
const getPageTitleFromPath = (pathname: string): string => {
  ...
  if (pathname.startsWith('/report/Generate-Action-Plan'))
    return 'Generate Action Plan';
  if (pathname.startsWith('/report/Generate-Holistic-Plan'))
    return 'Generate Holistic Plan';
  if (pathname.startsWith('/report/Generate-Recommendation'))

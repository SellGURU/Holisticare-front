...
import { LayoutDashboard, Users, MessageSquare,ClipboardList,LampDesk, Network, Palette, FlaskConical, Pill, PackageOpen,Settings, Activity, Plug, Shield} from 'lucide-react'
import { useState } from 'react';
import { useNavigate } from 'react-router-dom';

const sidebarGroups = [
  { group: 'CLINICAL', items: [
    { icon: LayoutDashboard, label: 'Dashboard', key: 'dashboard',url:'/dashboard' },
    { icon: Users, label: 'Clients', key: 'clients',url:'/' },
    { icon: MessageSquare, label: 'Messages', key: 'messages', badge: 4,url:'/messages' },
    { icon: Network, label: 'Knowledge Graph', key: 'knowledge-graph',url:'/aiKnowledge' },
    { icon:LampDesk , label: 'Playground', key: 'playground',url:'/playground' },
  ]},
  { group: 'CLINICAL ENGINE', items: [
    { icon: FlaskConical, label: 'Biomarkers', key: 'biomarkers',url:'biomarkers' },
    { icon: ClipboardList, label: 'Forms', key: 'forms',url:'forms' },
    // { icon: Network, label: 'Intelligence Models', key: 'health-models' },
    { icon: Pill, label: 'Intervention Library', key: 'intervention-library',url:"diet" }
  ]},
  { group: 'BRAND & EXPERIENCE', items: [
    { icon: Palette, label: 'Branding', key: 'branding',url:'custom-branding' },
  ...
  { group: 'ORGANIZATION', items: [
    ...
    { icon: PackageOpen, label: 'Packages', key: 'packages',url:'packages' },

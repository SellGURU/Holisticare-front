...
const wearables = [
  {
    name: 'Oura Ring',
    connected: true,
    params: ['Sleep', 'HRV', 'Readiness', 'Temperature'],
  },
  {
    name: 'Apple Health',
    connected: true,
    params: ['Steps', 'Heart Rate', 'Activity'],
  },
...
const chatMessages = [
  ...
  {
    sender: 'practitioner',
    text: "Great news, Mona! Yes please upload via the app. I'll review once it's in.",
    time: '1h ago',
  },
  {
    sender: 'client',
              ...
              <div className="grid grid-cols-5 gap-4">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-[12px] text-gray-400 mt-0.5">
                        ID: {selectedClient.id} · DOB: {selectedClient.dob}
                      </p>
                    </div>
                  </div>
                ...
                <div className="col-span-2 bg-white rounded-xl border border-gray-200/80 p-4">
                  ...
                  {practitioners.map((p) => (
                    <div
                      key={p.name}
                      className="flex items-center gap-3 p-2 rounded-lg bg-gray-50 mb-2"
                    >
                  ...
                  <div className="bg-white rounded-xl border border-gray-200/80 p-4">
                    ...
                    <div className="space-y-2">
                      {wearables.map((w) => (
                        <div
                          key={w.name}
                          className={`p-2.5 rounded-lg border ${w.connected ? 'bg-emerald-50/50 border-emerald-200' : 'bg-gray-50 border-gray-200'}`}
                        >
                          ...
                          {w.connected && (
                            <div className="flex flex-wrap gap-1 mt-1">
                              {w.params.map((param) => (
                                <span
                                  key={param}
                                  className="text-[9px] bg-white border border-emerald-200 text-emerald-700 px-1.5 py-0.5 rounded"
                                >
                                  {param}
                                </span>
                              ))}
                ...
                <div className="grid grid-cols-3 gap-3">
                  ...
                  <div className="bg-white rounded-xl border border-gray-200/80 p-4">
                    ...
                    <div className="space-y-2.5">
                      <div className="flex items-center justify-between p-2.5 bg-amber-50 rounded-lg border border-amber-100">
                        ...
                        <span className="text-[11px] font-bold text-amber-600 bg-amber-100 px-2 py-0.5 rounded">
                          Detected
                        </span>
                      </div>
                      <div className="flex items-center justify-between p-2.5 bg-red-50 rounded-lg border border-red-100">
                  ...
                  <div className="bg-white rounded-xl border border-gray-200/80 p-4">
                    ...
                    <div className="text-center mb-2">
                      ...
                      <p className="text-[26px] font-bold text-[#10B981]">
                        95.12%
                      </p>
                    </div>
                  ...
                  {events.map((ev, i) => (
                    <div key={i} className="flex gap-3 relative">
                      <div className="flex flex-col items-center">
                        <div
                          className={`w-2.5 h-2.5 rounded-full flex-shrink-0 mt-1 ${ev.status === 'ongoing' ? 'bg-blue-400 animate-pulse' : 'bg-gray-300'}`}
                        />
                        {i < events.length - 1 && (
                      ...
                      <div className="pb-3">
                        <p
                          className={`text-[11px] font-medium ${ev.status === 'ongoing' ? 'text-blue-700' : 'text-gray-600'}`}
                        >
                          {ev.text}
                        </p>
                        {ev.date ? (

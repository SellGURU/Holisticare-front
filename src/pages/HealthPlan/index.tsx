...
const chatMessages = [
  {
    sender: 'client',
    text: 'Hi doctor, I had my ApoB test done yesterday. Should I send the results through the app?',
    time: '2h ago',
  },
  {
    sender: 'practitioner',
    text: "Great news! Yes please upload via the app. I'll review once it's in.",
    time: '1h ago',
  },
  {
    sender: 'client',
    text: 'Perfect, uploading now. Also wanted to ask about the new supplement timing.',
    time: '45m ago',
  },
];
...
const holisticPlans = [
  {
    id: 1,
    name: 'Holistic Plan v2',
    date: '15 Jan 2025',
    shared: true,
    sharedDate: '16 Jan 2025',
  },
  {
    id: 2,
    name: 'Holistic Plan v1',
    date: '20 Oct 2024',
    shared: true,
    sharedDate: '21 Oct 2024',
  },
];
...
const planSummary = [
  ...
  {
    title: 'Supplements',
    items: 'Vitamin D3+K2, NAD+, Vitamin B12, Ashwagandha',
  },
  { title: 'Diet', items: 'Low-carb Mediterranean diet' },
  {
    title: 'Activity',
    items: 'Zone 2 cardio 3x/wk, Resistance training 2x/wk',
  },
  {
    title: 'Lifestyle',
    items: 'Cold exposure protocol, Blue light blocking, Meditation 15 min/day',
  },
...
function SectionHeader({ title, color, children }: any) {
  const colors: Record<string, string> = {
    green:
      'bg-gradient-to-br from-emerald-100 via-teal-50 to-cyan-100 border-l-emerald-500',
    blue: 'bg-gradient-to-br from-sky-100 via-blue-50 to-indigo-100 border-l-blue-500',
    purple:
      'bg-gradient-to-br from-violet-100 via-purple-50 to-fuchsia-100 border-l-violet-500',
    amber:
      'bg-gradient-to-br from-amber-100 via-yellow-50 to-orange-100 border-l-amber-500',
  };
  return (
    <div className="mb-3">
      <div
        className={`rounded-lg border-l-4 px-4 py-2.5 mb-3 ${colors[color]}`}
      >
...
function HealthPlan() {
  ...
  const displayName = useMemo(() => {
    if (personalInfo) {
      const full = [personalInfo.first_name, personalInfo.last_name]
        .filter(Boolean)
        .join(' ')
        .trim();
      if (full) return full;
        ...
        <div className="flex-1 min-w-0 space-y-4">
          ...
          <div className="grid grid-cols-5 gap-4">
            <div className="col-span-3 bg-white rounded-xl border border-gray-200/80 p-4">
              <div className="flex items-center gap-4">
                <div className="w-14 h-14 rounded-full bg-red-100 flex items-center justify-center text-[18px] font-bold text-red-700 flex-shrink-0">
              ...
              <div className="grid grid-cols-3 gap-4 mt-4 pt-3 border-t border-gray-100">
                <div>
                  ...
                  <p className="text-[13px] font-semibold text-gray-800 mt-0.5 truncate">
                    {personalInfo?.email || '—'}
                  </p>
                </div>
                <div>
                  <p className="text-[10px] text-gray-400 font-medium">Coach</p>
                  <p className="text-[13px] font-semibold text-gray-800 mt-0.5 truncate">
                    {personalInfo?.expert || '—'}
                  </p>
                </div>
            ...
            <div className="col-span-2 bg-white rounded-xl border border-gray-200/80 p-4">
              ...
              <div className="flex items-center gap-3 p-2 rounded-lg bg-gray-50 mb-2">
                <div className="w-8 h-8 rounded-full bg-[#0D9488] flex items-center justify-center text-white text-[10px] font-bold">
                  {getInitials(personalInfo?.expert || 'Coach')}
                </div>
                <div>
                  <p className="text-[12px] font-semibold text-gray-800">
                    {personalInfo?.expert || '—'}
                  </p>
                  <p className="text-[10px] text-gray-400">Assigned Coach</p>
                </div>
              </div>
          ...
          <SectionHeader title="Data Ingestion Status" color="green">
            <div className="grid grid-cols-3 gap-3">
              {/* Questionnaires */}
              <div className="bg-white rounded-xl border border-gray-200/80 p-4">
                <h4 className="text-[12px] font-bold text-gray-800 mb-2.5">
                  Questionnaires
                </h4>
                    ...
                    >
                      ...
                      <div className="flex items-center gap-0.5 flex-shrink-0">
                        {q.status === 'completed' ? (
                          <>
                            <button
                              className="w-5 h-5 rounded hover:bg-blue-50 flex items-center justify-center"
                              title="Preview"
                            >
                              <Eye className="w-3 h-3 text-gray-400" />
                            </button>
                            <button
                              className="w-5 h-5 rounded hover:bg-amber-50 flex items-center justify-center"
                              title="Retake"
                            >
                          ...
                          <>
                            <button className="px-1.5 py-0.5 bg-[#10B981]/10 text-[#059669] text-[9px] font-semibold rounded hover:bg-[#10B981]/20 transition-colors duration-150">
                              Take
                            </button>
                            <button
                              className="w-5 h-5 rounded hover:bg-blue-50 flex items-center justify-center"
                  ...
                  {testResults.map((t, i) => (
                    ...
                    >
                      <div className="min-w-0 flex-1">
                        ...
                        <p className="text-[9px] text-gray-400">
                          {t.date_uploaded || t.date_of_test || ''}
                        </p>
                      </div>
                      <div className="flex items-center gap-0.5 flex-shrink-0">
                        <button
                ...
                <div className="space-y-2">
                  ...
                  {wearables.map((w, i) => {
                    ...
                    return (
                      <div
                        key={w.Data ?? i}
                        className={`p-2.5 rounded-lg border ${connected ? 'bg-emerald-50/50 border-emerald-200' : 'bg-gray-50 border-gray-200'}`}
                      >
                ...
                <div className="space-y-2.5">
                  ...
                  <div className="flex items-center justify-between p-2.5 bg-amber-50 rounded-lg border border-amber-100">
                    ...
                    <span className="text-[18px] font-bold text-amber-600">
                      {questionnaires.length - completedQuestionnaires}
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-xl border border-gray-200/80 p-4">
                ...
                <div className="space-y-2.5">
                  <div className="flex items-center justify-between p-2.5 bg-emerald-50 rounded-lg border border-emerald-100">
                    ...
                    <span className="text-[18px] font-bold text-emerald-600">
                      {wearables.filter((w) => w.State === 'Connected').length}
                    </span>
                  </div>
              ...
              <div className="bg-white rounded-xl border border-gray-200/80 p-4">
                ...
                <div className="space-y-1">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[11px] text-gray-600">Focus</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <div className="w-2 h-2 rounded-full bg-[#10B981]" />
                    <span className="text-[11px] text-gray-600">Strength</span>
                  </div>
                </div>
              </div>
            ...
            <div className="grid grid-cols-3 gap-3">
              ...
              <div className="bg-white rounded-xl border border-gray-200/80 p-4">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <span className="text-[10px] text-gray-400">02 Apr 25</span>
                </div>
                <div className="flex items-center gap-3 mb-3">
                  <div>
                    ...
                    <span className="text-[12px] font-bold text-[#10B981] bg-emerald-50 px-1.5 py-0.5 rounded">
                      -1.6
                    </span>
                  </div>
                  <div className="flex-1 space-y-1.5 ml-2">
                    ...
                    <div className="flex items-center justify-between">
                      <span className="text-[10px] text-gray-500">Blood</span>
              ...
              <div className="bg-white rounded-xl border border-gray-200/80 p-4">
                ...
                <div className="text-center mb-3">
                  ...
                  <p className="text-[32px] font-bold text-[#10B981] leading-tight">
                    77
                  </p>
                </div>
                <div className="space-y-2">
                  ...
                  <div>
                    <div className="flex justify-between text-[10px] mb-0.5">
                      ...
                      <span className="font-bold text-gray-800">74</span>
                    </div>
                    <div className="h-1.5 bg-gray-100 rounded-full">
                      <div
            ...
            <div className="bg-white rounded-xl border border-gray-200/80 p-4">
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-3">
                  <select
                    ...
                    className="px-3 py-2 bg-gray-50 border border-gray-200 rounded-lg text-[12px] text-gray-700 focus:outline-none focus:ring-2 focus:ring-[#10B981]/20 focus:border-[#10B981] cursor-pointer"
                  >
                    {holisticPlans.map((p) => (
                  ...
                  {activePlan && (
                    <div className="flex items-center gap-2">
                      <span className="text-[10px] text-gray-400">
                        Generated: {activePlan.date}
                      </span>
                      {activePlan.shared ? (
                        <span className="text-[10px] text-emerald-600 bg-emerald-50 px-2 py-0.5 rounded font-medium">
                          Shared {activePlan.sharedDate}
                        </span>
                      ) : (
                        <button className="text-[10px] font-semibold text-white bg-[#10B981] px-2.5 py-1 rounded hover:bg-[#059669] transition-colors duration-150 flex items-center gap-1">
              ...
              <div className="space-y-0">
                {planSummary.map((item) => (
                  ...
                  >
                    <span className="text-[11px] font-bold text-gray-800 w-[120px] flex-shrink-0 pt-0.5">
                      {item.title}
                    </span>
        ...
        <div className="w-[300px] flex-shrink-0 space-y-4">
          ...
          <div className="bg-white rounded-xl border border-gray-200/80 p-4">
            ...
            <div className="space-y-1.5">
              {todos.map((todo, i) => (
                <div
                  key={i}
                  className="flex items-start gap-2.5 p-2 rounded-lg hover:bg-gray-50 transition-colors duration-150"
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <span
                      className={`text-[9px] font-bold px-1.5 py-0.5 rounded border mt-1 inline-block ${priorityColors[todo.priority]}`}
                    >
                      {todo.priority}
                    </span>
                  </div>
                ...
                return (
                  <div key={i} className="flex gap-3 relative">
                    <div className="flex flex-col items-center">
                      <div
                        className={`w-2.5 h-2.5 rounded-full flex-shrink-0 mt-1 ${ongoing ? 'bg-blue-400 animate-pulse' : 'bg-gray-300'}`}
                      />
                      {i < events.length - 1 && (
                    ...
                    <div className="pb-3">
                      <p
                        className={`text-[11px] font-medium ${ongoing ? 'text-blue-700' : 'text-gray-600'}`}
                      >
                        {ev.event_title}
                      </p>
                      {description ? (
          ...
          >
            <div className="px-4 py-3 border-b border-gray-100">
              <h3 className="text-[13px] font-bold text-gray-900">
                Chat{displayName ? ` with ${displayName.split(' ')[0]}` : ''}
              </h3>
            </div>
            <div className="flex-1 overflow-y-auto p-3 space-y-2.5">
              {chatMessages.map((msg, i) => (
                ...
                >
                  <div
                    className={`max-w-[85%] px-3 py-2 rounded-xl ${msg.sender === 'practitioner' ? 'bg-[#10B981]/10 text-gray-800' : 'bg-gray-100 text-gray-800'}`}
                  >
                    <p className="text-[11px] leading-relaxed">{msg.text}</p>
                    <p
                      className={`text-[9px] mt-1 ${msg.sender === 'practitioner' ? 'text-emerald-500' : 'text-gray-400'}`}
                    >
                      {msg.time}
                    </p>
                  </div>

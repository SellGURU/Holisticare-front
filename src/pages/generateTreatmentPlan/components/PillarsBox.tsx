...
const PillarsBox:React.FC<PillarsBoxProps> =({
    data,name
}) => {
            ...
            <div className="w-full bg-light-min-color dark:bg-[#2F2F2F] rounded-[6px] p-4 mt-4">
                <div className="w-full flex justify-center gap-2 items-start">
                    <div className="w-[60px] mr-3">
                        ...
                        <div className="text-[#FFFFFFDE] mt-1 tet-[10px] font-[500] text-center text-[10px]">{name}</div>
                    </div>       
                        ...
                        {data.map((el:any) => {
                            return (
                                <div className="w-full dark:bg-[#1E1E1E] bg-gray-200 mb-4 rounded-[6px] flex justify-start items-center p-4 h-[56px]">
                                    ...
                                    }} className="dark:bg-[#1E1E1E] w-full py-4 outline-none bg-gray-200  text-light-primary-text dark:text-[#FFFFFFDE] text-[12px] " type="text" value={el.text} />

...
const UploadCard: React.FC<UploadCardProps> = ({ index, question ,onSubmit}) => {
    ...
    <>
      <div className="bg-[#FCFCFC] p-3 w-full h-full rounded-[12px] border border-gray-50">
        <div className='flex justify-between items-center'>
          ...
          <div onClick={() => setISCanUpload(true)} className='cursor-pointer flex justify-end items-center gap-1'>
        ...
        <>
          <div className="w-full bg-white rounded-[8px] p-2 mt-4">
            ...
            <div className="w-full gap-4 flex justify-center items-center mt-2">
              <ItemUpload onUpload={(strem) => {
                setFrotal(strem)
              }} name="Frontal"></ItemUpload>
              <ItemUpload onUpload={(strem) => {
                setBack(strem)
              }} name="Back"></ItemUpload>
              <ItemUpload onUpload={(strem) => {
                setSide(strem)
              }} name="Side"></ItemUpload>
            </div>
          </div>

...
const ArrangeCard: React.FC<ArrangeCardProps> = ({ question, index, value }) => {
            ...
            {Array.from({
              ...
              return (
                <>
                  ...
                  }} className={`w-6  h-6 text-[12px] select-none cursor-pointer text-Text-Primary flex justify-center items-center ${startValue+ind == val && 'bg-Primary-EmeraldGreen border text-white border-gray-50 rounded-full'}`} style={{opacity:resolveTextOpacity(ind)}}>

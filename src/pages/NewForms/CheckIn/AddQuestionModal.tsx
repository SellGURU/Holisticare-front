...
const AddQuestionsModal:React.FC<AddQuestionsModalProps> = ({onCancel,onSubmit}) => {
    ...
    const submit = () => {
        const resolvedQuestion:checkinType = {
            ...
            response:"",
            type:type,
            options:type == 'Checkboxes'?CheckBoxoptions:type == 'Multiple choice'? multiChoiceOptions:undefined     
        }
    ...
    return (
        ...
        <div className="w-full border border-Gray-50 rounded-2xl p-4 bg-backgroundColor-Card mb-3 mt-2">
            <div className="w-full flex items-center justify-between">
                ...
                />
                <img
                    src={isDisabled()?`/icons/tick-square-background.svg`:`/icons/tick-square-background-green.svg`}
                    alt=""
            ...
            <div className="flex flex-wrap items-center gap-2 mt-2">
                ...
                <CheckBoxSelection isActive={type=="Checkboxes"} toggle={() => {
                    if(type == 'Checkboxes'){
                        setType("")
                    }else{
                        setType("Checkboxes")
                ...
                <MultiChoceSelection isActive={type =='Multiple choice'} toggle={() => {

        ...
        <div className="flex w-full items-center justify-between">
          ...
          <div className="w-[314px] h-[432px] rounded-xl bg-backgroundColor-Main flex flex-col p-3">
            <div className="flex w-full items-center justify-between mt-1">
              ...
              <div className='text-xs font-medium cursor-pointer text-Primary-DeepTeal flex items-center gap-1'> <img className='size-5' src="/public/icons/add-blue.svg" alt="" /> Add Exercise</div>
            </div>
            <SearchBox

        ...
        <div className="flex justify-between items-center">
          <div className="mt-2">
            ...
            <input
              type="number"
              value={sets}
              onChange={(e) => onChange(index, 'Sets', e.target.value,exesiseIndex)}
          ...
          <div className="mt-2">
            ...
            <input
              type="number"
              value={exercise.Reps}
              onChange={(e) => onChange(index, 'Reps', e.target.value,exesiseIndex)}
              className="w-[112px] px-3 text-center h-[24px] rounded-[8px] bg-white border border-gray-50 outline-none text-[10px] text-Text-Primary"
            />
          </div>
          <div className="mt-2 relative">
            ...
            <input
              ...
              onChange={(e) => onChange(index, 'Weight', e.target.value,exesiseIndex)}
          ...
          <div className="mt-2">
            ...
            <input
              type="number"
              value={exercise.Rest}
              onChange={(e) => onChange(index, 'Rest', e.target.value,exesiseIndex)}
              className="w-[112px] px-3 text-center h-[24px] rounded-[8px] bg-white border border-gray-50 outline-none text-[10px] text-Text-Primary"
            />
          </div>
        </div>

...
const EditModal =() => {
                ...
                src={
  {
    ...
    "Definition": "The LDL to HDL Cholesterol (LDL/HDL) ratio is a marker for cardiovascular health. A lower ratio is desirable as it indicates a healthier lipid profile.",
    "age_groups": [
      {
        "gender": "male",
        "status": {
    ...
    "label_mapping_chart": {
      ...
      "Needs Focus": "High"
                ...
                <div className=" w-full flex justify-end gap-4 items-center absolute bottom-4 right-4 ">
                    <div className="TextStyle-Headline-5 cursor-pointer text-Disable">Cancel</div>
                    <div className="TextStyle-Headline-5 cursor-pointer text-Primary-DeepTeal">Save</div>
                </div>
            </div>
        </>
    )

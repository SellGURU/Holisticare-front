...
const Tooltip: React.FC<{ text: React.ReactNode; children: React.ReactNode }> = ({
  text,
  children,
}) => {
  return (
        ...
        <div className="flex gap-6 absolute right-10 bg-white top-14">
            ...
            text={
                ...
                <div>
                    ...
                    {data.biomarker_insight?.map((b, i) => (
                        <li key={i}>{b}</li>
                    ))}
                    </ul>
                </div>

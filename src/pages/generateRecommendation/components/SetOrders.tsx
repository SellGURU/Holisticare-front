    ...
    <>
      ...
      >
        <div className=" w-full relative h-[380px] p-4 rounded-2xl bg-white">
         ...
         <p className='text-xs text-Text-Secondary   my-4'>Please complete all required fields before confirming your order.</p>
        ...
        />
                  ...
                  src={category.visible ? '/icons/eye-slash-blue.svg ' : "  /icons/eye-blue.svg"}
          ...
          <button className="text-sm font-medium text-Primary-DeepTeal" onClick={handleConfirm}>
            Confirm
          </button>
          </div>
        </div>

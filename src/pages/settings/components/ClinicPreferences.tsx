  ...
  return (
    <div className="bg-backgroundColor-Card min-h-[348px] w-full rounded-2xl relative shadow-100 p-4 text-Text-Primary ">
      ...
      <div className='w-full flex justify-between gap-4'>
        ...
        Text Preferences
        <Select value={Preferences} isLarge options={Options} onChange={(value)=>{setPreferences(value)}}/>
        </div>
        ...
        <textarea value={textValue} onChange={(e)=>settextValue(e.target.value)} placeholder='Enter any specific requests or areas of focus for your clinic' className='appearance-none resize-none w-full min-h-[116px] rounded-2xl border border-Gray-50 bg-[#FDFDFD] text-xs px-3 py-1 outline-none placeholder:text-[#B0B0B0] placeholder:font-light text-Text-Primary'/>
        </div>

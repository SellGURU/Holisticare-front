        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          <div className="pr-6">
            ...
            <div
              ...
              className="mt-4 rounded-lg p-4 text-white relative text-center overflow-hidden"
            >
              <img
          ...
          <div className="border-l border-Boarder pl-10">
            ...
            <p className="text-sm text-Text-Secondary mt-3">
              You have 23 days left in your package. If you cancel the
              subscription now, no refund will be issued but you can still use
              the remaining days.
            </p>

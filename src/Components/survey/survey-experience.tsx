...
export function SurveyExperience({ survey, assignment, uniqueCode }: SurveyExperienceProps) {
  ...
  const updateStatus = async (status: "not_started" | "in_progress" | "completed") => {
    try {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-purple-50 to-white pb-20">
      ...
      <div className="sticky top-0 z-10 w-full h-2 bg-gray-200 rounded-full overflow-hidden">
        <div className={progressClasses} style={{ width: `${calculateProgress()}%` }}></div>
      </div>
            ...
            <div className="mb-8 animate-float">
              <div className="w-20 h-20 text-center flex items-center justify-center">
                <svg className="w-16 h-16" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path d="M20 8V40" stroke="#9333EA" strokeWidth="2" strokeDasharray="2 2" />
                  <path d="M28 8V40" stroke="#9333EA" strokeWidth="2" strokeDasharray="2 2" />
                </svg>
              </div>
            </div>
            <SurveyLanding

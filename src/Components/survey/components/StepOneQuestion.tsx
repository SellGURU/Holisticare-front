...
import { CardHeader,Card, CardTitle, CardDescription, CardContent, CardFooter } from "../../ui/card";
...
const StepOneQuestion: React.FC<StepOneQuestionProps> = ({ survey, visibleQuestions, handleStart }) => {
  return (

...
interface MainQuestionBoxProps {
    ...
    renderQuestion: (question: ApiQuestion, questionIndex: number) => React.ReactNode;
}

const MainQuestionBox: React.FC<MainQuestionBoxProps> = ({error,handlePrevious,handleNext,submitting,action, validationErrors,gradientClass,showSaveIndicator,currentStep, visibleQuestions,currentQuestion ,renderQuestion,getOriginalIndexForVisibleIndex}) => {
    return (
        <>
            <Card

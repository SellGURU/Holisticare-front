...
const UploaderTooltipContainer = () => {
    ...
    return (
            <>
                <div className=" absolute flex justify-end top-0 pt-12 pr-4 right-0 " style={{zIndex: 1000}}>
                    {isUploading &&
                        <div className="bg-white rounded-[16px] h-[100px] border border-gray-50  w-[320px] p-4">
                            <div className="flex justify-between items-center">
                                <div className="text-[12px] text-Primary-DeepTeal font-medium">File History</div>
                                <img onClick={() => {
                                    setIsUploading(false)
                                }} className="cursor-pointer" src="/icons/close.svg" alt="" />
                            </div>
                            {files?.map(() => {
                                return (
                                    <>

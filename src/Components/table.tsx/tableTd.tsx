        ...
        <div className="w-[15vw]">
          ...
          >
            <div className="flex items-center justify-start gap-2 ">
              ...
              />
              <div title={row.original?.name} className="font-meidum text-xs   text-Text-Primary text-nowrap flex items-center gap-3">
                
                <div className='truncate max-w-[90px] xl:max-w-[160px]'>{row.original?.name || 'No Data'}</div>
                <FiExternalLink />
              </div>
            </div>
          </Link>

...
const RecentCheckIns: React.FC = () => {
  ...
  return (
    <div className="w-full bg-white rounded-2xl shadow-200 p-4 pr-2 " style={{height:(window.innerHeight-200)/2 -16 +'px'}}>
      <div className=" overflow-y-scroll pb-3 pr-[2px] " style={{height:(window.innerHeight-350)/2 - 24+'px'}}>

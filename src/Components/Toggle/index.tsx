...
const Toggle: React.FC<ToggleProps> = ({ value, active, setActive,isClientList }) => {
  return (
    <>
      <div className={` bg-backgroundColor-Main ${isClientList ? "h-8 w-[324px]" : " h-7 w-[294px] " }  px-2 flex justify-between items-center rounded-[24px] gap-1`}>

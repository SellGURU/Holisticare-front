...
const BiomarkersPrint:React.FC<BiomarkersPrintProps> = ({data}) => {
    ...
    return (
        <>
            <div className="w-full no-split relative h-48 border bg-gray-50  border-gray-100 rounded-md px-4 border-l-4 py-2" style={{borderLeftColor:resolveColor(resovleStatusFromValue(data.values[0]))}}>
                <div>
                  <div className=" flex justify-start items-center">
                    ...
                    <div className="text-sm flex items-center  mt-2">
                        ...
                        <div className="flex items-center flex-row">
                            <div className="text-xs font-medium ">{data.values[0]+ " "+data.unit}</div>
                            <div className="w-3 h-3 mr-1 rounded-full " style={{backgroundColor:resolveColor(resovleStatusFromValue(data.values[0]))}}></div>

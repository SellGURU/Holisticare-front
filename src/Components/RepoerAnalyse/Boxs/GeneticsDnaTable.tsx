      ...
      <table className="w-[345px] rounded-lg bg-white text-[10px]">
        ...
        <tbody>
          {data.map((item, index) => (
            <tr
              key={index}
              className={`${index % 2 !== 0 ? 'bg-[#F4F4F4]' : 'bg-white'} hover:bg-gray-50`}
            >
              <td className="px-2 py-2 whitespace-nowrap text-[#383838]">
                {item.gene_name}
              </td>
              <td className="px-2 py-2 whitespace-nowrap text-[#888888]">
                {item.rsID}
              </td>
              <td className="px-2 py-2 whitespace-nowrap text-[#888888]">
                {item.reference}

                ...
                <div className="flex flex-col gap-6 w-full">
                  ...
                  <div className="flex  w-full items-center gap-2 xs:gap-6">
                    ...
                    >
                      ...
                      <div className={` text-[8px]  xs:text-[10px]  md:text-xs font-medium underline text-Primary-DeepTeal cursor-pointer absolute ${isSaveClicked &&
                        extractedBiomarkers.length + addedBiomarkers.length ? 'bottom-4 lg:bottom-6' : 'bottom-6'} `}>

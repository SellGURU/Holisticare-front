...
const UploadPModal:React.FC<UploadPModalProps> = ({
    OnBack,uploadedFile,onSave,isShare,errorMessage,handleFileChange,
    handleDeleteFile,formatFileSize,fileInputRef,modifiedDateOfTest,handleModifiedDateOfTestChange,
    extractedBiomarkers,setExtractedBiomarkers,addedBiomarkers,handleAddBiomarker,handleTrashClick,
    handleConfirm,handleCancel,deleteIndex,addedDateOfTest,handleAddedDateOfTestChange
    }) => {

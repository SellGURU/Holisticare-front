...
const UploadPModal: React.FC<UploadPModalProps> = ({
  ...
  return (
    <>
      <div style={{height: window.innerHeight - 40 + 'px'}} className="w-full rounded-[16px md:h-[89vh] top-4 flex justify-center absolute left-0 text-Text-Primary md:pr-[95px]">
        ...
        <div
          ...
          className="bg-white p-3 md:p-6 rounded-md w-full overflow-auto h-fit z-10"
        >
          <div className="w-full flex items-center justify-between">
            ...
            <ButtonPrimary
              disabled={
                extractedBiomarkers.length == 0 && addedBiomarkers.length == 0
              }
              onClick={onSave}

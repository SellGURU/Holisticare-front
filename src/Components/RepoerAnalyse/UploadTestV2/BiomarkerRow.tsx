...
interface BiomarkerRowProps {
    ...
    updateAndStandardize:(biomarkerId:string,updatedField:Partial<any>) => void
}


const BiomarkerRow:React.FC<BiomarkerRowProps> = ({
    index,updateAndStandardize,showOnlyErrors,biomarker,renderValueField
    ,errorText,isHaveError,allAvilableBiomarkers,refRenceEl,handleConfirmDelete
}) => {
    ...
    return (
        <>
            ...
            className={
                `${showOnlyErrors && !isHaveError ? 'hidden' : ''} ${isHaveError ? 'bg-[#FFD8E480]' : index % 2 === 0 ? 'bg-white' : 'bg-backgroundColor-Main'} grid    biomarker-grid-desktop biomarker-grid-mobile py-1 px-4 border-b border-Gray-50 items-center text-[8px] md:text-xs text-Text-Primary`         
            }
            style={{
                gridTemplateColumns:
            ...
            >
                <div className="text-left text-Text-Primary flex gap-1">
                 ...
                 <div className="text-center">
                    <SearchSelect
                        ...
                        value={
                            isHaveError &&
                            errorText.includes('System Biomarker')
                            ? '...'
                            : biomarker.biomarker
                        }
                ...
                <div className=" flex justify-center">
                    ...
                    <Select
                        ...
                        value={
                        isHaveError &&
                        errorText.includes('Extracted Unit')
                            ? '...'

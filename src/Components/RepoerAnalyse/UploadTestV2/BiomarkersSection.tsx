...
const BiomarkersSection: React.FC = () => {
  ...
  const [dateOfTest, setDateOfTest] = useState<Date | null>(new Date('2024-04-05'));

  const handleTrashClick = (indexToUpdate: number) => {
    setBiomarkers(biomarkers.map((biomarker, index) => {
        ...
        <div className="w-full">
          <div className="flex justify-between items-center mb-4">
            <div className="text-sm font-medium">
              List of Biomarkers <span className='text-[#B0B0B0] text-xs font-medium'>({biomarkers.length})</span>
            </div>
          ...
          <div className="overflow-x-auto">
            <div className="w-full min-w-[700px] text-xs">
              {/* Table Header */}
              <div className="grid grid-cols-7 gap-4 py-1 px-4 font-medium text-Text-Primary text-xs bg-[#E9F0F2] border-b rounded-t-[12px] border-Gray-50">
                <div className="col-span-1 w-[169px] ">Extracted Biomarker</div>
                <div className="col-span-1 w-[180px] text-center">System Biomarker</div>
                <div className="col-span-1 w-[180px] text-center">Extracted Value</div>
                <div className="col-span-1 w-[141px] text-end">Extracted Unit</div>
                <div className="col-span-1 w-[175px] text-center">System Value</div>
                <div className="col-span-1 w-[189px] text-center">System Unit</div>
              ...
              <div className="w-full overflow-y-auto max-h-[350px]">
                {biomarkers.map((biomarker, index) => (
                  ...
                  >
                    <div className="col-span-1 w-[169px]">{biomarker.extractedName}</div>
                    <div className="col-span-1 w-[180px] text-center">
                        <Select isSetting value={biomarker.systemName} onChange={()=>{}}></Select>
                    ...
                    <Select isSmall isSetting value={biomarker.extractedUnit} onChange={()=>{}}></Select>

    ...
    <>
      {loading ? (
        ...
        <>
          ...
          >
            {accessManager.filter((el) =>el.name == 'Client Summary')[0].checked == true &&
             ...
             {accessManager.filter((el) =>el.name == 'Needs Focus Biomarker')[0].checked == true &&
              <>
            ...
            {accessManager.filter((el) =>el.name == 'Detailed Analysis')[0].checked == true &&
            ...
            {accessManager.filter((el) =>el.name == 'Holistic Plan')[0].checked == true &&
              <div className="my-[200px] min-h-[650px]">
            ...
            {accessManager.filter((el) =>el.name == 'Action Plan')[0].checked == true &&

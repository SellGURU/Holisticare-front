...
export const SlideOutPanel: React.FC<SlideOutPanelProps> = ({ isOpen, onClose, children,headline }) => {
  ...
  return (
    <div ref={showModalRefrence} className={`fixed top-0 right-0 h-full w-[320px] bg-white border-[2px] border-r-0 border-Gray-25 rounded-tl-2xl rounded-bl-2xl  shadow-lg transform transition-transform duration-300 ${isOpen ? 'translate-x-0' : 'translate-x-full'}`}>

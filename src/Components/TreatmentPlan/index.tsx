  ...
  return (
    <div className="my-10">
          ...
          >
            ...
            >
              <div className=" flex w-full justify-center items-center flex-col gap-2">
                ...
                >
                  <div
                    style={{ backgroundColor: resolveStatusColor(card.status) }}
      ...
      <div className="w-full flex justify-end gap-2 my-3">
        <ButtonPrimary> <img src="/icons/status-up.svg" alt="" /> Analysis</ButtonPrimary>
        <ButtonPrimary> <img src="/icons/chart.svg" alt="" /> Client Goals</ButtonPrimary>
      </div>

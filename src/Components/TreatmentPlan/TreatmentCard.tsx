...
const TreatmentCard: React.FC<TreatmentCardProps> = ({ data }) => {
  return (
    <div className="w-[354px] no-split print:w-full h-full  print:h-auto flex flex-col gap-4 px-4 py-2 bg-backgroundColor-Card border border-Gray-50 rounded-2xl relative ">

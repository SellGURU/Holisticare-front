      ...
      <div className="w-full flex justify-between items-center flex-wrap gap-3">
        <div className="text-sm text-Text-Primary ">{data?.title}</div>
        {
          !isOther && (
            ...
            <div data-tooltip-id="system-score" className="bg-[#E2F1F8] rounded-full px-2 flex items-center gap-1">
              ...
              >
                ...
                <div className="text-Text-Secondary">Score based on all data and AI insights.</div>
              </Tooltip>
            </div>
            <div data-tooltip-id="base-score" className="bg-[#DAF6C6] rounded-full px-2 flex items-center gap-1">
              ...
              >
                <div>Base Score</div>
                <div className="text-Text-Secondary">Initial score from core health metrics.</div>
              </Tooltip>
            </div>
            <div className="text-Primary-DeepTeal select-none">Score Calculation
            <Tooltip
                id={'base-score'}
                place="top"
                className="!bg-white !w-[162px] !leading-5 !text-wrap !shadow-100 !text-[#888888] !text-[10px] !rounded-[6px] !border !border-Gray-50 !p-2"

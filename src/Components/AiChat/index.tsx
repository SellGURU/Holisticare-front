...
const formatText = (text:string) => {
  ...
  return (
    <div className="w-full h-[400px]  mx-auto bg-white border-light-border-color dark:bg-black-primary border dark:border-main-border  rounded-md relative flex flex-col ">
